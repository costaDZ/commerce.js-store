...
export const AddressForm = ({ checkoutToken, next }) => {
  ...
  const subDevition = Object.entries(
          ...
          <Form.Row className={"justify-content-center"}>
            <Col xs={12} md={6} xl={5}>
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setFormInfo({ ...formInfo, first_name: e.target.value })
                }
              />
            </Col>
            <Col xs={12} md={6} xl={5}>
              ...
              {shippingCountry && (
                <>
                  ...
                  <Form.Control
                    ...
                    required
                    onChange={(e) =>
                      handelSelect(e, setShippingSubdivision, "state")
                    }
                  >
                    <option></option>
                    {subDevition.map((devition) => (
                      <option key={devition.id} value={devition.id}>
                        {devition.name}
                      </option>
                    ))}
                  </Form.Control>
          ...
          <Form.Row className={"justify-content-center"}>
            <Col xs={12} md={6} xl={5}>
              ...
              <Form.Control
                ...
                required
                onChange={(e) =>
                  handelSelect(e, setShippingOption, "shiping_option")
                }
              >
                <option></option>
                {shippingOptions
